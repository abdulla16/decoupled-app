...
namespace DecoupledApp\Helpers;
 ...
 * Minor edits by Abdulla Al-Qawasmeh. We do not want to throw execptions on missing data or missing properities.
 * We just want the class to map data that matches in both the JSON and the corresponding class.
